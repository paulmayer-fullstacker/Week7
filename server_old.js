...
app.all("*", (req, res) => {   // Last route handler defined will catch any incorrect route.
  res.status(404).sendFile(path.join(__dirname, "public", "404.html")); // Serve directory route along with 404 error.
});
